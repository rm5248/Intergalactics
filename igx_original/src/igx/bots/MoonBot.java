...
/**
 * This is a sample robot. It isn't too great a player, but the code is available if you want to see
 * just what's involved in writing a 'bot.
 *
...
public class MoonBot extends Bot
{
    ...
    /**
     * The method is called when a new game is begun. The MoonBot doesn't need to do anything here, but
     * other 'bots might find use for this.
     */
    ...
    /**
     * This function is overridden so there are only two MoonBots (Only two skill levels).
     */
     ...
     *
     * The MoonBot is very simplified. It finds the closest planet it doesn't own and tries to attack
     * that planet. Occasionally, it will reinforce the planet it owns with the highest kill ratio.
     */
