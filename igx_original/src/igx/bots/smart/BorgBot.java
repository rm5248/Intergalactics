...
public class BorgBot extends Bot
{
  ...
  /**
   * The BorgBot does a lot of enumerating of planets by different criteria. Here are
   * the filters for these criteria. The first finds planets that the BorgBot owns.
   */
               ...
               if (t.getOwner() == Constants.NEUTRAL) {
                  ...
                  if (game.getDistance(i, target) <= CLOSE_THRESHOLD[who]) {
                     ...
                     if (needed <= availableShips[planet[i]]) {
                        ...
                        // Occasionally reinforce the cluster
