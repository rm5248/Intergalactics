...
/**
 * Contains an entire game state from the player's point of view. You don't need to create one of
 * these, you'll get one passed to you when the server calls your 'bot's {@link Bot#update update}
 * method.
 * <P>
 * The game state contains all information at given turn:segment. Included in this information is
 * the number of players, the player information, the planet information, a list of fleets that
 * arrived this turn, etc. See methods below give you access to this information.
 *
...
public class GameState
{
  ...
  /**
   * This function returns the arrival time if the given fleet is sent at the given time.
   *
  ...
  /**
   * Returns a convenient integer time format. time = (turn-1) * Constants.SEGMENTS + segment.
   *
   * @see Constants
   */
  public int getTime () {
