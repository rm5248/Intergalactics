...
/**
 * The TalkBot is an abstract bot that has built-in support for the standard IGX
 ...
 * @modified slightly by Toby Hudson to cope with the fact that messaging is
 * done differently in the RobotArena as compared to the server.
 */
public class TalkBot extends Bot {
    ...
    /**
     * If you override this be <b>sure</b> to call <code>super.newGame</code>.
     */
