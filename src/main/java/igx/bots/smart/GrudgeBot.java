...
public class GrudgeBot extends Bot {
    ...
    //////////////////////////////////////////////////////////
    /**
     * The GrudgeBot does a lot of enumerating of planets by different criteria.
    ...
    /**
     * This filter finds planets that are close to a point, are owned by us and
     * have available ships.
     */
    ...
    static class NearestEnemyFilter extends PlanetFilter {
         ...
         */
        public boolean isValid(int p) {
            return ((((enemy == -1) && (g.getPlanet(p).getOwner() != me))
