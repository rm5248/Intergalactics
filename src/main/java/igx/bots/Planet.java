...
public class Planet {
    ...
    /**
     * True if the planet is neutral (and therefore no other information is
     * available).
     */
    ...
    /**
     * Array of attackers... attackers[i] is the number of attackers of this
     * planet owned by player i.
     */
    ...
    /**
     * Returns the number of the player who owns the planet. This will be
     * Constants.NEUTRAL if the planet is neutral.
     */
    public int getOwner() {
        return owner;
    }
    ...
    /**
     * Returns true if this planet has been consumed by a black hole (whatever
     * that means...)
     */
