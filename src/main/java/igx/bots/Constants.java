...
/**
 * Contains all the constants in igx that could be relevant to your 'bot. These
 * constants will synchronize with the server's constants, so don't go using any
 * magic numbers.
 * <P>
 * If any of these constants seem confusing, then maybe you don't fully
 * understand the igx game engine. Is it the case? Well, then if not for your
 * own sake, but for the sake of your poor, unenlightened 'bot, read up on it in
 * the igx
 * <A HREF="http://www.cs.utoronto.ca/~jw/iCONv2/manual.html">Player's
 * Guide</A>. Any further inquiries regarding the igx game engine can be
 * directed to
...
public class Constants {
    ...
    /**
     * Sending a message to this player number will result in the message being
     * sent to ALL players.
     */
    ...
    /**
     * Special production maximum. This is the highest production a planet will
     * ever achieve due to random events.
     */
    public static final int SPECIAL_MAX_PRODUCTION = Params.SPECIALPRODMAX;

    /**
     * Special ratio maximum. This is the highest ratio a planet will ever
     * achieve due to random events.
     */
